    ...
    <div className="flex flex-col h-full rounded-[var(--radius-xl)] border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden" style={{ boxShadow: 'var(--shadow-lg)' }}>
      ...
      <div className="flex items-center justify-between px-5 py-3.5 border-b border-[var(--color-border)] bg-[var(--color-surface)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-sm font-semibold" style={{ color: 'var(--color-ink)' }}>{currentAgent.name}</h3>
            <p className="text-[11px]" style={{ color: 'var(--color-text-tertiary)' }}>{currentAgent.desc}</p>
          </div>
        </div>
                  ...
                  {AGENTS.map(agent => {
                    ...
                    return (
                      <button
                        ...
                        style={{
                          backgroundColor: isActive ? agent.color + '10' : 'transparent',
                        }}
