...
/**
 * Coach page now redirects to the unified Super Agent chat.
 * The super-agent automatically routes career coaching queries
 * to the coach agent when appropriate.
 */
