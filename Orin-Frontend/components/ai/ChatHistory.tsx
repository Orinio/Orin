...
import type { StorageTier } from '@/lib/chat-types';
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3" style={{ borderBottom: '1px solid var(--color-border)' }}>
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={onClose}
              className="p-1.5 rounded-lg transition-colors hover:bg-black/5 lg:hidden"
              ...
              {filtered.map((c) => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2.5 rounded-xl text-xs transition-all duration-150 group/item flex items-start gap-2 ${
                    c.id === currentConversationId ? '' : 'hover:bg-black/[0.03]'
                  }`}
                  style={{
        ...
        <div className="px-4 py-3" style={{ borderTop: '1px solid var(--color-border)' }}>
          <div className="flex items-center gap-2 text-[10px] opacity-30" style={{ fontFamily: 'var(--font-mono)' }}>
            ...
            {tier === 'cloud' ? 'Synced to cloud' : 'Stored locally'}
          </div>
        </div>
      </div>
    </>
