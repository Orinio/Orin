 ...
 */
export type ErrorCode = 'UNAUTHORIZED' | 'FORBIDDEN' | 'NOT_FOUND' | 'VALIDATION_ERROR' | 'MISSING_FIELDS' | 'RATE_LIMITED' | 'GLOBAL_RATE_LIMITED' | 'CONFLICT' | 'DEPENDENCY_FAILED' | 'TIMEOUT' | 'INTERNAL_ERROR' | 'NOT_CONFIGURED' | 'EXTERNAL_SERVICE_ERROR';
