...
export const createProofSchema = z.object({
  ...
  skills_extracted: z.array(z.string().max(50)).max(20).optional(),
  skills_user_added: z.array(z.string().max(50)).max(20).optional(),
  what_it_proves: z.array(z.string().max(200)).max(10).optional(),
