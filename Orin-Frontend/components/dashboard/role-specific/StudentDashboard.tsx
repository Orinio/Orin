...
import { Plus, BarChart3, TrendingUp, Briefcase, RefreshCw, User, ExternalLink, Sparkles, ArrowRight, ArrowUpRight, ArrowDownRight } from "lucide-react";
    ...
    return (
      <div className="space-y-6">
        <div className="card-premium p-8 text-center">
          <RefreshCw className="mx-auto h-10 w-10" style={{ color: 'var(--color-pulse)' }} />
