...
exports.verifyLinkedInTool = exports.verifyKaggleTool = exports.verifyCertificateTool = exports.verifyGithubUserTool = exports.verifyGithubRepoTool = void 0;
exports.verifyGithubRepoTool = {
    ...
    execute: async (args) => {
        try {
            ...
            if (!res.ok)
                return { success: true, data: { exists: false, status: res.status } };
...
exports.verifyCertificateTool = {
    ...
    execute: async (args) => {
        try {
            ...
            if (domain.includes('coursera'))
                platform = 'Coursera';
            else if (domain.includes('udemy'))
                platform = 'Udemy';
            else if (domain.includes('edx'))
                platform = 'edX';
            else if (domain.includes('linkedin'))
                platform = 'LinkedIn Learning';
            else if (domain.includes('hackerrank'))
                platform = 'HackerRank';
            else if (domain.includes('leetcode'))
                platform = 'LeetCode';
            else if (domain.includes('aws.amazon'))
                platform = 'AWS';
